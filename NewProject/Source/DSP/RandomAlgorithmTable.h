...
inline const std::array<RandomAlgorithmOffsets, kNumAlgorithmTicks> randomAlgorithmTable = {{
    ...
    // Tick 9
    { 0.23f, 0.23f,     0.0f, 0.0f,   60.0f, 60.0f,
      0.3f, 0.3f,     0.3f, 0.3f,   0.0f, 0.0f, 0.0f },

    // Tick 10
    { 0.25f, 0.25f,     0.0f, 0.0f,   100.0f, 100.0f,
    ...
    // Tick 13
    { 0.28f, 0.28f,   3.0f, 3.0f,   10.0f, 10.0f,
      0.45f, 0.45f,   0.45f, 0.45f, 0.0f, 0.0f, 0.0f },

    // Tick 14
    { 0.28f, 0.28f,     4.0f, 4.0f,   30.0f, 30.0f,
    ...
    // Tick 16
    { 0.31f, 0.31f,     4.0f, 5.0f,   50.0f, 45.0f,
      0.5f, 0.5f,     0.5f, 0.5f,   0.12f, 0.0f, 0.0f },

    // Tick 17
    { 0.32f, 0.32f,   5.0f, 6.5f,   50.0f, 50.0f,
